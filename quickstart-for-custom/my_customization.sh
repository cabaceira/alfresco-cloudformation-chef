...
curl -sL 'https://s3-eu-west-1.amazonaws.com/road2alfresco-utilities/jar-modules/share/javascript-console-share-0.7-SNAPSHOT.jar' -o /usr/share/tomcat-alfresco/modules/share/javascript-console-share-0.7-SNAPSHOT.jar
